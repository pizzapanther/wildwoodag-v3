    ...
    function D(e) {
        ...
        if ((l.originalEvent && (l = l.originalEvent), i.isTouched)) {
            if (!i.isTouchEvent || 'touchmove' === l.type) {
                ...
                if (
                    (i.allowTouchCallbacks && a.emit('touchMove', l), !(l.targetTouches && l.targetTouches.length > 1))
                ) {
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== r) {
                        ...
                        'string' == typeof w && w.indexOf('%') >= 0 && (w = (parseFloat(w.replace('%', '')) / 100) * r),
                            ...
                            i.slidesPerColumn > 1 &&
                                ((T =
                                    Math.floor(c / i.slidesPerColumn) === c / e.params.slidesPerColumn
                                        ? c
                        ...
                        for (
                            var M, z, P, k = i.slidesPerColumn, L = T / k, $ = Math.floor(c / i.slidesPerColumn), I = 0;
                            I < c;
                            I += 1
                        ) {
                            S = 0;
                ...
                translateTo: function (e, t, a, i, s) {
                    ...
                    if (((l = i && e > d ? d : i && e < p ? p : e), r.updateProgress(l), n.cssMode)) {
                        ...
                        if (0 === t) o[u ? 'scrollLeft' : 'scrollTop'] = -l;
                            ...
                            o.scrollTo((((c = {})[u ? 'left' : 'top'] = -l), (c.behavior = 'smooth'), c));
                ...
                slideTo: function (e, t, a, i) {
                    ...
                    if (o.cssMode) {
                        ...
                        if ((u && (S = h.scrollWidth - h.offsetWidth - S), 0 === t))
                            ...
                            h.scrollTo((((x = {})[T ? 'left' : 'top'] = S), (x.behavior = 'smooth'), x));
                ...
                (r.mount = function (e) {
                    ...
                    return (
                        ...
                        e && e.shadowRoot && e.shadowRoot.querySelector
                            ? ((a = m(e.shadowRoot.querySelector('.' + t.params.wrapperClass))).children = function (
                                  e,
                              ) {
                                  return i.children(e);
                              })
            ...
            handle: function (e) {
                ...
                if (
                    ...
                    if (
                        (T.push(y),
                        S
                            ? (y.direction !== S.direction || y.delta > S.delta || y.time > S.time + 150) &&
            ...
            init: function () {
                ...
                e.a11y.addElId(n, o),
                    ...
                    r &&
                        ...
                        'BUTTON' !== r[0].tagName &&
                            (e.a11y.addElRole(r, 'button'), r.on('keydown', e.a11y.onEnterOrSpaceKey)),
                    ...
                    e.pagination &&
                        ...
                        e.pagination.bullets &&
                        e.pagination.bullets.length &&
                        e.pagination.$el.on('keydown', z(e.params.pagination.bulletClass), e.a11y.onEnterOrSpaceKey);
            },
            destroy: function () {
                var e,
                    t,
                ...
                a.a11y.liveRegion && a.a11y.liveRegion.length > 0 && a.a11y.liveRegion.remove(),
                    ...
                    a.pagination &&
                        ...
                        a.pagination.$el.off('keydown', z(a.params.pagination.bulletClass), a.a11y.onEnterOrSpaceKey);
            },
        },
        re = {
            init: function () {
            ...
            setTranslate: function () {
                ...
                for (var v = 0; v < s.length; v += 1) {
                    ...
                    if (
                        ...
                        0 === C.length &&
                            ((C = m('<div class="swiper-slide-shadow-' + (c ? 'left' : 'top') + '"></div>')),
                            f.append(C)),
                            0 === M.length &&
                                ((M = m('<div class="swiper-slide-shadow-' + (c ? 'right' : 'bottom') + '"></div>')),
                                f.append(M)),
            ...
            setTranslate: function () {
                for (
                    ...
                    if ((h.transform(S), (h[0].style.zIndex = 1 - Math.abs(Math.round(f))), r.slideShadows)) {
                        ...
                        0 === C.length &&
                            ((C = m('<div class="swiper-slide-shadow-' + (n ? 'left' : 'top') + '"></div>')),
                            h.append(C)),
                            0 === M.length &&
                    ...
                    if (t.realIndex !== a.realIndex || r) {
                        ...
                        if (a.params.loop) {
                            a.slides.eq(l).hasClass(a.params.slideDuplicateClass) &&
                                (a.loopFix(), (a._clientLeft = a.$wrapperEl[0].clientLeft), (l = a.activeIndex));
                            var d = a.slides
                                    .eq(l)
                        ...
                        r && (n += 'next' === o ? s : -1 * s),
                            a.visibleSlidesIndexes &&
                                ...
                                (a.params.centeredSlides
                                    ? (n = n > l ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1)
                                    : n > l && (n = n - i + 1),
